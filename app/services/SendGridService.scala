...
object SendGridService {
  ...
  def receiptRejectionBody: String =
    """<p><span style="color: #222222;"><span style="font-family: open sans,sans-serif;"><span style="font-size: small;"> Oh No, Something Went Wrong!
      |</span> </span> </span></p>
      |<p><span style="color: #222222;"><span style="font-family: open sans,sans-serif;"><span style="font-size: small
      |;"> Thank you for trying, but we were unable to process your receipt. Please take a new picture and upload it again at&nbsp
      |; </span> </span> </span> <a href="http://cappthenight.3kudos.com/login"><span style="color: #1155cc;"> <span style="font-family
      |: open sans,sans-serif;"> <span style="font-size: small;"> <u> CappTheNight.3kudos.com/login</u></span></span></span></a>.</p>
      |<p><span style="color: #222222;"><span style="font-family: open sans,sans-serif;"> <span style="font-size: small;
      |"> We are here to help, so if you have any problems or questions, email us at&nbsp;</span></span></span>
      |<a href="mailto:support@receiptprocessor.com"><span style="color: #1155cc;"><span style="font-family: open sans,sans-serif
      |;"><span style="font-size: small;"><u>support@receiptprocessor.com</u></span></span></span></a>.</p>""".stripMargin

  def registrationBody: String =
    """<p style="text-align: left;"><span style="font-family: 'Times New Roman', serif;"> <span style=
      |"color: #222222;"> <span style="font-family: open sans,sans-serif;"> <span style="font-size: small;"> You&rsquo;re Good To Go!</span></span></span></span></p>
      ...
      | qualifying Hills Bros. Cappuccino products and upload your receipt to&nbsp; </span> </span></span>
      | <a href="http://cappthenight.3kudos.com/login"><span style="color: #1155cc;"> <span style="font-family: open sans,sans-serif;"> <span style=
      | "font-size: small;"> <u>CappTheNight.3kudos.com/login</u></span></span></span></a>.<span style="color: #000000;"> <span style=
      | "font-family: 'Times New Roman', serif;"><span style="font-size: small;"> You can also</span></span></span> <span style="
      | color: #222222;"> <span style="font-family: open sans,sans-serif;"><span style="font-size: small;">visit&nbsp;</span></span>
      | </span> <a href="http://www.cappthenightsweepstakes.com/"><span style="color: #1155cc;"><span style="font-family: open sans,sans-serif;">
      | <span style="font-size: small;"> <u>http://www.cappthenightsweepstakes.com/</u></span></span></span></a><span style="color: #222222;">
      | <span style="font-family: open sans,sans-serif;"> <span style="font-size: small;">daily for additional ways to earn sweepstake entries
      | . For each receipt you upload, you will earn 10 entries to win a $2,500 shopping spree and Hills Bros. Cappuccino prize pack. 1 receipt upload per day. </span>
      | </span></span></p>""".stripMargin

  def approvalBody: String =
    """<p><span style="color: #222222;"><span style="font-family: open sans,sans-serif;"> <span style="font-size: small
      |;"> Congratulations! You&rsquo;ve Earned 10 Entries!</span></span></span></p>
      |<p><span style="color: #222222;"><span style="font-family: open sans,sans-serif;"><span style="font-size: small;
      |"> Your receipt has been approved! To earn additional entries, upload more receipts at</span></span></span>&nbsp;<a href=
      |"http://cappthenight.3kudos.com/login"><span style="color: #1155cc;"><span style="font-family: open sans,sans-serif;">
      |<span style="font-size: small;"><u>CappTheNight.3kudos.com/login</u></span></span></span></a>&nbsp;<span style="color: #000000;">
      |<span style="font-family: open sans,sans-serif;"><span style="font-size: small;">or visit&nbsp;</span> </span></span> <a href=
      |"http://www.cappthenightsweepstakes.com/"><span style="color: #1155cc;"> <span style="font-family: open sans,sans-serif;"> <span style=
      |"font-size: small;"> <u>http://www.cappthenightsweepstakes.com/</u></span></span></span></a>.</p>""".stripMargin
}
